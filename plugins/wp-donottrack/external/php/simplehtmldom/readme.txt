Simple HTML DOM Parser can be found at http://simplehtmldom.sourceforge.net/. The original download contains the changelog below, the manual, testcases and the works. The license is the MIT License.
